...
// configuration step. It creates a namespace called `rl_engine`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", rl_engine::cmake::project_name, rl_engine::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", rl_engine::cmake::project_version);
      return EXIT_SUCCESS;
    }
